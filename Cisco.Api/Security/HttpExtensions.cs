...
/// </summary>
/// <remarks>
/// The handlers here log the whole <see cref="HttpRequestMessage"/> as a log argument. Its
/// <c>ToString()</c> renders every header, so the Authorization header this client sets on each
/// request was written verbatim into the log. These helpers produce the same information with the
/// credential removed.
/// </remarks>
